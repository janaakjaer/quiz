...
<html lang="da"> <!-- 'lang' fortæller skærmlæsere, at sproget er dansk -->
    ...
    <body>
        ...
        <form action='question3.php' method='post'> <!-- Send oplysninger til siden question3.php -->
            ...
            <input type='radio' name='quest2' value='svar 1'> Kong Frederik d. 9. (IX)<br>
            <input type='radio' name='quest2' value='svar 2'> Kong Christian d. 10. (X)<br>            
            <input type='radio' name='quest2' value='svar 3'> Kong Frederik d. 10. (X)<br><br>
