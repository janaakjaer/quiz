...
<html lang="da"> <!-- 'lang' fortæller skærmlæsere, at sproget er dansk -->
    <head>
        ...
        <title>Genforenings- og Grænsemuseets quiz | Spørgsmål 7</title> <!-- Titel på faneblad/side -->
    ...
    <body>
        ...
        <form action='question8.php' method='post'> <!-- Send oplysninger til siden question8.php -->
            ...
            <input type='radio' name='quest7' value='Svar 7 - 1'> Kong Christian d. 10.<br>
            <input type='radio' name='quest7' value='Svar 7 - 2'> Kong Frederik d. 7.<br>            
            <input type='radio' name='quest7' value='Svar 7 - 3'> Gorm den Gamle<br><br>
